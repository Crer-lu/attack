...
if os.path.exists("weights/adversarial_image_black_class/noise_simulator.ckpt"):
    noise_simulator.load_state_dict(torch.load("weights/adversarial_image_black_class/noise_simulator.ckpt"))

if os.path.exists("weights/adversarial_image_black_class/latent_classifier.ckpt"):
    latent_classifier.load_state_dict(torch.load("weights/adversarial_image_black_class/latent_classifier.ckpt"))
...
for iteration in progress:
    ...
    if iteration % SAVE_DELTA==SAVE_DELTA - 1:
        torch.save(noise_simulator.state_dict(),f"weights/adversarial_image_black_class/noise_simulator_{iteration}.ckpt")
        torch.save(noise_simulator.state_dict(),f"weights/adversarial_image_black_class/noise_simulator.ckpt")
        torch.save(latent_classifier.state_dict(),f"weights/adversarial_image_black_class/latent_classifier_{iteration}.ckpt")
        torch.save(latent_classifier.state_dict(),f"weights/adversarial_image_black_class/latent_classifier.ckpt")
